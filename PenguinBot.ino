...
int musicNumber = 4;
// ===============================================
// CODIGO MODIFICADO: Cambia este número (1, 2, 3 o 4) para elegir tu baile fijo
const int BAILE_FIJO = 2;
// ===============================================
int danceIndex = 2;
    ...
    // /*
        if (irValue != '\0')// Bluetooth serial port data stream on app side (character acquisition is completed in timer 2)
        {
            ...
            case BTN_DANCE:
                ...
                // Ahora usamos el baile fijo que configures arriba del todo
                danceIndex = BAILE_FIJO; 
